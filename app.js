...
window.addEventListener('load', ()=>{
    ...
    speak("I'm a virtual assistant. My name is shocave. I'm developed by sakshi shetty");
    wishMe("");
})
...
function speakThis(message) {
    ...
    if(message.includes('hi') || message.includes('hello')) {
        ...
        const finalText = "I'm a virtual assistant. My name is shocave. I'm developed by sakshi shetty. I can help you that you want. Still I'm under devloping. I think insha allah I'll be more powerful with sakshi shetty. Thank You";
        speech.text = finalText;
    }
        ...
        const finalText = "I'm developed by sakshi shetty. Let see his profile";
